      ...
      <div className="cards">
        <div className="cardInfo">
          ...
          <div className="inputSignature">
            <input disabled  type="text" name="" id="signTeacher" value={course2.firmaDocente} readonly onmousedown="return false;" />
            <input disabled  type="text" name="" id="signStudent" value={course2.firmaEstudiante} readonly onmousedown="return false;" />
          </div>
        </div>
      </div>
    </div>
